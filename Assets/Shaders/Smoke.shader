...
Shader "Smoke"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 appendResult17 = (float4(mulTime15 , 0.0 , 0.0 , 0.0));
			float2 uv_TexCoord14 = i.uv_texcoord + appendResult17.xy;
			float simplePerlin2D2 = snoise( uv_TexCoord14 );
...
/*ASEBEGIN
Version=18500
7;1;1906;1010;1319.867;-0.5038452;1;True;False
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;2;-374.38,287.7809;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;13;-119.9509,61.7365;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.1;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;7;-739.585,190.3484;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleTimeNode;4;-735.2406,329.3651;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1;-696.1422,29.61023;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;9;-84.68582,309.816;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;8;-536.4901,340.2258;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;166.3832,272.7167;Inherit;False;Constant;_Float1;Float 1;1;0;Create;True;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DitheringNode;19;195.5944,77.97672;Inherit;False;0;False;3;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=6C4103F020FFAC8E17385AF268DFBF106CE5FEE4