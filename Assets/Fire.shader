	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float simplePerlin3D9 = snoise( float3( (texCoord11*3.0 + ( ase_worldPos + _TimeParameters.x ).xy) ,  0.0 ) );
				simplePerlin3D9 = simplePerlin3D9*0.5 + 0.5;
				float3 temp_cast_2 = (simplePerlin3D9).xxx;
				
				surfaceDescription.Color = float3( 0.5, 0.5, 0.5 );
				surfaceDescription.Emission = temp_cast_2;
...
/*ASEBEGIN
Version=18912
1511;1364;1907.2;986.2;1705.091;846.6892;1.670799;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;13;-594.1,157.3;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleTimeNode;8;-510.1,332.3;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-467.1,10.29999;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;14;-354.1,219.3;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;10;-148.1,156.3;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT;3;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;9;137.9,151.3;Inherit;True;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;179.9,-34.70001;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;319.9,-131.7;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BillboardNode;15;-285.5023,-237.7495;Inherit;False;Cylindrical;True;0;1;FLOAT3;0
...
ASEEND*/
//CHKSM=662374878CF741BCA5961DE231F96785104387E6