    ...
    public class HBAO : CustomPostProcessVolumeComponent, IPostProcessComponent
    {
        ...
        */
        ...
        private static class ShaderProperties
        {
            ...
            public static string GetDirectionsKeyword(Quality quality)
            {
                switch (quality)
                {
                    case Quality.Lowest:
            ...
            public static string GetStepsKeyword(Quality quality)
            {
                switch (quality)
                {
                    case Quality.Lowest:
        ...
        */
        ...
        private void UpdateShaderKeywords()
        {
            ...
            m_ShaderKeywords[1] = ShaderProperties.GetDirectionsKeyword(quality.value);
            m_ShaderKeywords[2] = ShaderProperties.GetStepsKeyword(quality.value);
            m_ShaderKeywords[3] = ShaderProperties.GetNoiseKeyword(noiseType.value);
            //m_ShaderKeywords[4] = ShaderProperties.GetDeinterleavingKeyword(deinterleaving.value);
            m_ShaderKeywords[4] = ShaderProperties.GetDeinterleavingKeyword(Deinterleaving.Disabled);
            m_ShaderKeywords[5] = ShaderProperties.GetDebugKeyword(debugMode.value);
            m_ShaderKeywords[6] = ShaderProperties.GetMultibounceKeyword(useMultiBounce.value);
            m_ShaderKeywords[7] = ShaderProperties.GetOffscreenSamplesContributionKeyword(offscreenSamplesContribution.value);
            m_ShaderKeywords[8] = ShaderProperties.GetPerPixelNormalsKeyword(perPixelNormals.value);
            m_ShaderKeywords[9] = ShaderProperties.GetBlurRadiusKeyword(blurType.value);
            m_ShaderKeywords[10] = ShaderProperties.GetVarianceClippingKeyword(varianceClipping.value);
            m_ShaderKeywords[11] = ShaderProperties.GetColorBleedingKeyword(colorBleedingEnabled.value);
