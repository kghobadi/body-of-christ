	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Texture0 = packedInput.ase_texcoord6.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float4 tex2DNode18 = tex2D( _Texture0, uv_Texture0 );
				dither12 = step( dither12, tex2DNode18.a );
				...
				surfaceDescription.Alpha = dither12;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 clipScreen12 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither12 = Dither4x4Bayer( fmod(clipScreen12.x, 4), fmod(clipScreen12.y, 4) );
				float2 uv_Texture0 = packedInput.ase_texcoord1.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float4 tex2DNode18 = tex2D( _Texture0, uv_Texture0 );
				dither12 = step( dither12, tex2DNode18.a );
		...
		Pass
		{
					...
					)
			{
				...
				float2 clipScreen12 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither12 = Dither4x4Bayer( fmod(clipScreen12.x, 4), fmod(clipScreen12.y, 4) );
				float2 uv_Texture0 = packedInput.ase_texcoord2.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float4 tex2DNode18 = tex2D( _Texture0, uv_Texture0 );
				dither12 = step( dither12, tex2DNode18.a );
		...
		Pass
		{
					...
					)
			{
				...
				float2 clipScreen12 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither12 = Dither4x4Bayer( fmod(clipScreen12.x, 4), fmod(clipScreen12.y, 4) );
				float2 uv_Texture0 = packedInput.ase_texcoord4.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float4 tex2DNode18 = tex2D( _Texture0, uv_Texture0 );
				dither12 = step( dither12, tex2DNode18.a );
		...
		Pass
		{
						...
						)
			{
				...
				float2 clipScreen12 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither12 = Dither4x4Bayer( fmod(clipScreen12.x, 4), fmod(clipScreen12.y, 4) );
				float2 uv_Texture0 = packedInput.ase_texcoord8.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float4 tex2DNode18 = tex2D( _Texture0, uv_Texture0 );
				dither12 = step( dither12, tex2DNode18.a );
...
/*ASEBEGIN
Version=18912
2603.2;33.6;1907.2;985.4;1103.1;476.9;1;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;17;-633.1001,-364.9;Inherit;True;Property;_Texture0;Texture 0;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;18;-335.1001,-253.9;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;16;-461.1001,199.1;Inherit;False;2;2;0;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;11;-676.1,-163.9;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DitheringNode;12;-134.1,152.1;Inherit;False;0;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;14;-774.1001,38.10001;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-561.1001,101.1;Inherit;False;2;2;0;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;50.8999,-52.89999;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=50B758F0FA4110C98BD0FB2AA3D023EC784BA7BB