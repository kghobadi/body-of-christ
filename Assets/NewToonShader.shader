	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 temp_cast_0 = (step( 1 , 0.5 )).xxx;
				...
				surfaceDescription.Emission = temp_cast_0;
...
/*ASEBEGIN
Version=18912
2634.4;-1.6;1909.6;1085.4;954.3;538.9;1;True;False
Node;AmplifyShaderEditor.LightAttenuation;11;-539.3,122.1;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;12;-317.3,169.1;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
